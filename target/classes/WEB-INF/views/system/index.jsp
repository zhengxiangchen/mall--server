        ...
        <div id="northPanel" data-options="region: 'north', border: false" style="height: 80px; overflow: hidden;">
            <div id="topbar" class="top-bar">
                <div class="top-bar-left">
                    <h1 style="margin-left: 10px; margin-top: 10px;color: #fff">shopping<span style="color: #3F4752">后台管理系统</span></h1>
                </div>
            ...
            <div id="toolbar" class="panel-header panel-header-noborder top-toolbar">
                ...
                <div id="buttonbar">
                    ...
                    <div id="layout_north_set">
                    	<div id="btnUpdatePwd" data-options="iconCls:'logout'" onclick="updatePwd()">修改密码</div>
